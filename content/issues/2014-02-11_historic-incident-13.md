...
As a result, many upstream connections were affected and this would have caused some level of packet loss for clients, ranging from minor to extreme, for approximately 30 minutes. Depending on where users connect to your service from would depend on whether they were affected. 

Our group’s network and infrastructure team were alerted to identify the destination of the attack, which was null-routed as soon as the target could be identified. Given the size of the attack and activity on social networking sites, we believe it was organised by a team of professional attackers who also claim to have taken down some very large organisations this evening.

We are intensively monitoring the network traffic to ensure there is no recurrence.
